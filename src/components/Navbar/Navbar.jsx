            ...
            <nav className={`bg-[#FFE353] border-gray-200 
                ...
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div className="links flex items-center justify-center gap-0.5 lg:hidden" >
                        ...
                        {/* Dropdown */}
                        <div className="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow-sm " id="language-dropdown-menu">
                            <ul className="py-2 font-medium" role="none">
                                <li>
                                    <button className="block py-2 text-sm text-gray-700 hover:bg-gray-100 " role="menuitem">
                    ...
                    <div className="  hidden lg:flex lg:items-center">
                        ...
                        <button type="button" data-dropdown-toggle="language-dropdown-menu" className="inline-flex items-center font-medium justify-center px-4 py-2 text-sm text-gray-900  rounded-lg cursor-pointer hover:bg-gray-100 smooth">
