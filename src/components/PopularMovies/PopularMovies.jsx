...
import PopularPagination from '../PopularPagination/PopularPagination';
import { useWatchList } from '../../context/WatchlistContext/WatchlistContext';
import toast from 'react-hot-toast';
export default function PopularMovies() {
    const { popularMovies, currentPopularPage, scrollToTop } = useContext(MoviesContext)
    ...
    return (
        <div className="container mx-auto my-10 p-5">
            <h1 className='text-3xl font-semibold my-10 text-start'>Movies / Popular Movies</h1>
                ...
                {popularMovies.map((movie) => {
                    ...
                    return (
                        <Link to={"/movieDetails/" + movie.id}
                            onClick={() => scrollToTop()}
                            state={{ from: "/popular", page: currentPopularPage }}
